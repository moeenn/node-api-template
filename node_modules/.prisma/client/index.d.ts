...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__RoleClient<T, Null = never> implements PrismaPromise<T> {
    ...
    users<T extends RoleUsersArgs= {}>(args?: Subset<T, RoleUsersArgs>): PrismaPromise<Array<UserRoleGetPayload<T>>| Null>;
  ...
  export interface UserRoleDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): PrismaPromise<Array<UserRoleGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__UserRoleClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    roles<T extends UserRolesArgs= {}>(args?: Subset<T, UserRolesArgs>): PrismaPromise<Array<UserRoleGetPayload<T>>| Null>;
